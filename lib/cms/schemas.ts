...
export const cmsProductSchema = z.object({
  ...
  backImage: cmsImageSchema.nullable().optional(),
...
/** BE may send enabled as boolean or 0/1 (and occasionally "0"/"1"). */
export const cmsEnabledFlagSchema = z
  .union([z.boolean(), z.literal(0), z.literal(1), z.literal("0"), z.literal("1")])
  .transform((value) => value === true || value === 1 || value === "1");

export const cmsFormatsCatalogStatusSchema = z.object({
  enabled: cmsEnabledFlagSchema,
